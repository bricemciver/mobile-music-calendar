 ...
 */
function syncEventsToCalendar(): void {
  try {
 ...
 */
function fetchEventData(apiEndpoint: string): EventData {
  try {
 ...
 */
function getDatesRange(eventData: EventData): { earliest: Date; latest: Date } {
 ...
 */
function createEventDescription(apiEvent: Event): string {
 ...
 */
function createEventId(title: string, startTime: Date): string {
